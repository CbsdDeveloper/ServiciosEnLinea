...
.directive('menuPermissions',function(){
	return {templateUrl:pathMenu+'menuPermissions.html'};
})
.directive('menuVacations',function(){
	return {templateUrl:pathMenu+'menuVacations.html'};
})
.directive('menuProcessContracts',function(){
	return {templateUrl:pathMenu+'menuProcessContracts.html'};
})
.directive('menuPsychosocialEvaluation',function(){
	return {templateUrl:pathMenu+'menuPsychosocialEvaluation.html'};
})
...
.directive('cardProfileHome',function(){
	return {templateUrl:pathInc+'cardProfileHome.html'};
})
